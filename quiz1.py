...
bg = PhotoImage(file = "lvl1bg.png")
label1 = Label( root, image=bg)
label1.place(x=0,y=0,relwidth=1,relheight=1)
nextimg=PhotoImage(file="next1.png")
submitimg=PhotoImage(file="sub1.png")
...
def ques():
    qn1=Label(root,bg="#25180F",fg="white",text=question[question_number-1],width=42,font=("ms sans serif",15),anchor='n')
...
def enable():
    if (question_number)==11:
        ...
        hintb.config(background="#C69805")
...
def question_display():
    x_pos=90
    for i in range(1,16):
        labe=Label(root,text=i,width=5,bg="#F8C94E")
...
timerl=Label(root, textvariable=timer_label,width=4,font=(6),bg="#C69805")
...
def end():
    ...
    if correct_answers>=(data_size*0.8):
        ...
        f.write("2")
        f.close()
    if correct_answers>=(data_size*0.8) and lvl=="1":
        mb.showinfo("Congratulations!","Level 2 is now unlocked")
    home()
...
nextb=Button(root,command=nxt_btn,image=nextimg,borderwidth=0,activebackground="#25180F",bg="#25180F",fg="white")
nextb.place(x=740,y=250)
fiftyb=Button(root,text="50-50",command=fifty,borderwidth=0,activebackground="#C69805",bg="#C69805",font=("lucida",12),width=8)
fiftyb.place(x=723,y=100)
hintb=Button(root,text="Hints",command=hints,borderwidth=0,activebackground="#C69805",bg="#E3242B",font=("lucida",12),width=8,state="disabled")
...
#creation of menubar
menubar = Menu(root)
filemenu = Menu(menubar,background="#422402")
menubar.add_cascade(label='Menu',background="#422402", menu=filemenu)
filemenu.add_command(label="Home",background="#C69805",foreground="black",command=quithome)
filemenu.add_separator()
filemenu.add_command(label='Instructions',background="#C69805",foreground="black",command=instructions)
filemenu.add_separator()
filemenu.add_command(label='Exit',background="#C69805",foreground="black", command=quit)
helpmenu = Menu(menubar,background="#422402")
